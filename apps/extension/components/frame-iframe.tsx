...
export default function FrameIFrame({ url, frameId, theme }: FrameIFrameProps) {
  ...
  return (
    <div
      className="flex flex-col overflow-hidden items-center justify-center w-full text-gray-700 rounded-lg bg-gray-100 dark:bg-black dark:text-gray-200 aspect-video relative transition-all duration-150 ease-in-out"
      style={{
        aspectRatio
      }}>
      {error ? (
